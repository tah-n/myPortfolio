...
const InputPlaceHolder = ({text,type,value,onChange,length}: PropsType) => {
  ...
  return (
    <Button className='!p-1 !relative' borderClassName='opacity-10'>
        <input value={value} onChange={onChange} type={type} className='outline-none bg-white/10 w-[200px] md:w-[300px] h-10 p-3' onFocus={() => setMovePlaceHolder(true)} onBlur={() => setMovePlaceHolder(true)}   />
