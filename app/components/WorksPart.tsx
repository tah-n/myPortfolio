  ...
  return (
    <Container ref={containerRef} closeButton={handleClose} className='' >
      <div className='relative h-[90vh] flex flex-col items-center justify-center' >
        <WorksText containerRef={containerRef} text='Brain wave' href='https://brain-wave-tau.vercel.app/' imgSrc='works/brainwave.png'    />
        <WorksText containerRef={containerRef} text='jetBrain' href='https://jet-brains-copy.vercel.app/' imgSrc='works/jetbrains.png'  />
        <WorksText containerRef={containerRef} text='travel Book' href='https://traveling-site-gamma.vercel.app/' imgSrc='works/travel.png'  />
