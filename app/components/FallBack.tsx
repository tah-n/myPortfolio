                ...
                <div ref={containerRef} className="relative w-full h-full">
                    ...
                    {[...Array(5)].map((_, i) => (
                        <div
                            ...
                            className="circles border opacity-0 z-10 absolute top-0 left-0 border-white rounded-full w-32 h-32"
                        />
                    ))} 
                     <em className="text-white/60 absolute -top-2 -left-[23px]">Loading...</em>
                </div>
            </div>
        </Html>
    );
